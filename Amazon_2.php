...
<main class="ma">
    <header>
        <p class="haut">
            ...
            <form method="" action="" class="rec">
               <input type="submit" class="a" name="menu" value="All"/>
                <input  type="search" class="b" placeholder="Rechercher un article" name="nom" value=""/>
        ...
        <p class="haut2">
            <a href=""><img src="menu.png" width="25px" height="25px" class="menu"/></a>
            <ul class="lien">
    ...
    <?php
        //session_start();
        echo '<center><strong><font size=6px>Bienvenu '.$_SESSION['nom'].'</font></strong></center>';
    ?>
    <body>
        <center>
            <br/><br/>
        ...
        <div class="page">
            ...
            <div class="case6">
                <img src="boites.jpg" width="270px" height="270px"/><div class="s9"></div><br/><br/>
            </div>
